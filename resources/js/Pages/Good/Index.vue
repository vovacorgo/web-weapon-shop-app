...
<!--&lt;!&ndash;                        v-if="good.slides.length > 1" &ndash;&gt;-->

<!--&lt;!&ndash;                        <Splide :options="mainOptions" ref="main">&ndash;&gt;-->
<!--&lt;!&ndash;                            <SplideSlide v-for="slide in good.slides" :key="slide">&ndash;&gt;-->
<!--&lt;!&ndash;                                <div class="flex justify-center">&ndash;&gt;-->
<!--&lt;!&ndash;                                    <img class="rounded-lg" :src="slide" :alt="good.title" :title="good.title" />&ndash;&gt;-->
<!--&lt;!&ndash;                                </div>&ndash;&gt;-->
<!--&lt;!&ndash;                            </SplideSlide>&ndash;&gt;-->
<!--&lt;!&ndash;                        </Splide>&ndash;&gt;-->

<!--&lt;!&ndash;                        <Splide :options="thumbsOptions" ref="thumbs">&ndash;&gt;-->
<!--&lt;!&ndash;                            <SplideSlide v-for="slide in good.slides" :key="slide">&ndash;&gt;-->
<!--&lt;!&ndash;                                <img :src="slide" :alt="good.title" />&ndash;&gt;-->
<!--&lt;!&ndash;                            </SplideSlide>&ndash;&gt;-->
<!--&lt;!&ndash;                        </Splide>&ndash;&gt;-->
<!--                    </div>-->
